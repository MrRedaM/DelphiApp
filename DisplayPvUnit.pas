...
begin
  with MainForm.DBGrid do begin
    Ref.Caption := 'Référence courrier: ' + Fields[1].AsString;
    Date.Caption := 'Date de réalisation: ' + Fields[2].AsString;
    Adr.Caption := 'Personne à contacter: ' + Fields[3].AsString;
    Phone.Caption := 'Téléphone / Mobile : ' + Fields[4].AsString;
    Mail.Caption := 'Email: ' + Fields[5].AsString;
    Fax.Caption := 'Fax : ' + Fields[6].AsString;
    Travail.Caption := 'Travail effectué: ' + Fields[8].AsString;
